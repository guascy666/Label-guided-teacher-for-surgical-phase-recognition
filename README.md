...
In this papaer, we propose a novel label-guided teacher network for knowledge
...
learning framework to learn better feature embeddings. Then, by min
imizing feature similarity, the knowledge learnt by our teacher network
