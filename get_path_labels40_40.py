...
root_dir = '/data2/guanjl/data_phase_new_250/data/cholec80'
img_dir = os.path.join(root_dir, 'image_new_250')
...
for j in range(len(tool_file_names)):
    ...
    for tool_line in tool_file:
        ...
        if tool_count > 1:
            ...
            info_each = []
            img_file_each_path = os.path.join(img_dir_paths[j], 'frame' + str(tool_count - 2) + '.jpg')
    ...
    print("tool_count:",tool1,"phase_count:",phase1)
...
with open('/data2/guanjl/Swin_32_8_40/cholec80.pkl', 'wb') as f:
    pickle.dump(all_info_all, f)

import pickle

with open('/data2/guanjl/Swin_32_8_40/cholec80.pkl', 'rb') as f:
...
with open('./train_val_test_paths_labels_40_40.pkl', 'wb') as f:
